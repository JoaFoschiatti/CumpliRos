...
export class TemplatesController {
  ...
  @Public()
  @ApiOperation({
    summary: "Listar rubros disponibles con cantidad de plantillas",
  })
  ...
  @ApiParam({
    name: "templateKey",
    example: "rosario.gastronomia.habilitacion_comercial",
  })
  @ApiResponse({
    status: 200,
    description: "Plantilla encontrada",
    type: ObligationTemplateResponseDto,
  })
  ...
  async findByJurisdictionAndRubric(
    ...
    return this.templatesService.findByJurisdictionAndRubric(
      jurisdictionId,
      rubric,
    );
  }
...
export class OrganizationTemplatesController {
  ...
  @ApiResponse({
    status: 201,
    description: "Plantillas aplicadas",
    type: ApplyTemplatesResultDto,
  })
  @ApiResponse({
    status: 400,
    description: "No se encontraron plantillas para el rubro especificado",
  })
  async applyTemplates(
    ...
    return this.templatesService.applyToOrganization(
      organizationId,
      dto,
      user.id,
    );

...
export class ObligationsController {
  ...
  @ApiResponse({
    status: 200,
    description: "Dashboard de obligaciones",
    type: ObligationDashboardDto,
  })
  async getDashboard(
    @Param("organizationId") organizationId: string,
  ...
  @ApiResponse({
    status: 200,
    description: "Detalles de la obligación",
    type: ObligationResponseDto,
  })
  async findOne(
    @Param("organizationId") organizationId: string,
  ...
  @ApiResponse({
    status: 200,
    description: "Obligación actualizada",
    type: ObligationResponseDto,
  })
  async update(
    @Param("organizationId") organizationId: string,
  ...
  async updateStatus(
    ...
    return this.obligationsService.updateStatus(
      organizationId,
      obligationId,
      status,
      user.id,

...
export class OrganizationsController {
  ...
  @ApiResponse({ status: 201, description: 'Organización creada', type: OrganizationResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Detalles de la organización', type: OrganizationResponseDto })
  async findOne(@Param('organizationId') organizationId: string): Promise<OrganizationResponseDto> {
  ...
  @ApiParam({ name: 'organizationId', type: 'string' })
  @ApiResponse({ status: 200, description: 'Estadísticas', type: OrganizationStatsDto })
  async getStats(@Param('organizationId') organizationId: string): Promise<OrganizationStatsDto> {
  ...
  @ApiParam({ name: 'organizationId', type: 'string' })
  @ApiResponse({ status: 200, description: 'Lista de miembros', type: [OrganizationMemberDto] })
  async getMembers(@Param('organizationId') organizationId: string): Promise<OrganizationMemberDto[]> {
  ...
  async updateMemberRole(
    ...
    await this.organizationsService.updateMemberRole(organizationId, memberId, dto, user.id);
  }
  ...
  async removeMember(
    ...
    await this.organizationsService.removeMember(organizationId, memberId, user.id);
  }
}

...
export class JurisdictionsController {
  ...
  @ApiResponse({ status: 200, description: 'Lista de jurisdicciones', type: [JurisdictionSummaryDto] })
  ...
  @ApiResponse({ status: 200, description: 'Jurisdiccion por defecto', type: JurisdictionResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Jurisdiccion encontrada', type: JurisdictionResponseDto })
  @ApiResponse({ status: 404, description: 'Jurisdiccion no encontrada' })
  async findByCode(@Param('code') code: string): Promise<JurisdictionResponseDto> {
  ...
  @ApiResponse({ status: 200, description: 'Detalles de la jurisdiccion', type: JurisdictionResponseDto })
  @ApiResponse({ status: 404, description: 'Jurisdiccion no encontrada' })
  ...
  async create(@Body() dto: CreateJurisdictionDto): Promise<JurisdictionResponseDto> {

import { Controller, Get, Query, Param, UseGuards, Res, Header } from '@nestjs/common';
...
import { ReportFilterDto, ComplianceReportDto, ObligationReportItemDto } from './dto/report.dto';
...
export class ReportsController {
  ...
  @ApiResponse({ status: 200, description: 'Reporte de cumplimiento', type: ComplianceReportDto })
  ...
  @ApiParam({ name: 'organizationId', type: 'string' })
  @ApiResponse({ status: 200, description: 'Lista de obligaciones', type: [ObligationReportItemDto] })

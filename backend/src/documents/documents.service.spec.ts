...
describe("DocumentsService", () => {
  ...
  describe("create", () => {
    ...
    it("should throw BadRequestException for invalid MIME type", async () => {
      ...
      await expect(
        service.create(organizationId, userId, invalidFile),
    ...
    it("should throw BadRequestException for file exceeding max size", async () => {
      ...
      await expect(
        service.create(organizationId, userId, largeFile),
      ).rejects.toThrow("El archivo excede el tamaño máximo permitido (10 MB)");
    });
  ...
  describe("findOne", () => {
    ...
    it("should throw NotFoundException if document not found", async () => {
      ...
      await expect(service.findOne("org-123", "doc-123")).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("delete", () => {
    ...
    it("should throw NotFoundException if document not found", async () => {
      ...
      await expect(service.delete("org-123", "doc-123")).rejects.toThrow(
        NotFoundException,
      );
    });
